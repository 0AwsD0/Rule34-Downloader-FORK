...
class r34DwnldrGUI:
    ...
    def processQueue(queue: Queue, uiSetFunc, name="unnamed"):
        ...
        :param name: optional, the name of this queue (for debugging)k/da_ahri
        :return:
        """
...
# region: button actions
    ...
    def search(self):
        ...
        print("total Expected ", self.totalExpected)
        print("self.tagiiterator = ", self.tagiiterator)
        print("self.searchTerm = ", self.searchTerm)

        if self.totalExpected == 0:
            print("Spotted 0 IMAGES!")
            self.checkCanBegin()
            self.tagi()
            self.search()
        elif self.totalExpected != 0 and self.tagiiterator != 0:
    ...
    def begin(self):
        ...
        if self.done:
            ...
            self.tagi()
            self.search()
            print("Back to button function search term:")
            print(self.ui.searchInput.setText(self.searchTerm))
            print("Tagi iterator: ")
            print(self.tagiiterator)
