...
- TAGSWITCH version will switch between tags that you provide in mainGUI.py after finishing download but will not start downloading. If certain tag have 0 matches, program will move to next one. YOU HAVE TO INSERT YOUR TAGS AND PACK EXE YOUR SELF
- AUTOMATED version will switch between tags that you provide in mainGUI.py and AUTOMATED will download all of them. If certain tag have 0 matches, program will move to next one. YOU HAVE TO INSERT YOUR TAGS AND PACK EXE YOUR SELF
...
- in TAGSWITCH version program will switch the tag and you can click SEARCH to check if it returns some images. If not program will switch to the next one.
